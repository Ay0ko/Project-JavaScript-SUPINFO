document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    if (movieData.Response === "True") {
      ...
      plotElement.innerHTML = `<strong>Resume :</strong> ${
        movieData.Plot || "Résumé non disponible."
      }`;
    ...
    alert(
      "Une erreur est survenue lors de la récupération des détails du film."
    );
  }
});
